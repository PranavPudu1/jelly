...
import { AmbiencePhoto, Review } from '../types';
import { AppColors, Typography, Spacing } from '../theme';

const { width, height } = Dimensions.get('window');

interface AmbianceReelModalProps {
    visible: boolean;
    onClose: () => void;
...
export default function AmbianceReelModal({
    visible,
    onClose,
    photos,
    allReviews,
    initialPhotoIndex = 0,
}: AmbianceReelModalProps) {
                ...
                {showTooltip && (
                    ...
                    >
                        <Text style={styles.tooltipText}>
                            Scroll for more ambiance pictures
                        </Text>
                    </Animated.View>
                )}
